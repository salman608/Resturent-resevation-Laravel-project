                            ...
                            @foreach($items as $item)
                                <li class="item "  id="{{$item->category->slug}}">
                                  <a href="#"  data-toggle="modal" data-target="#myModal">
                                    <img src="{{('uploads/item/'.$item->image)}}" class="img-responsive" alt="item" style="height:270px;">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Please Reserve Your Item</h4>
      </div>
      ...
      <form class="reservation-form" method="post" action="{{route('reservation.reserve')}}">
                              @csrf
                                  ...
                                  <div class="form-group col-md-12">
                                      <input type="text" class="form-control reserve-form empty iconified" name="name" id="name"  placeholder="  &#xf007;  Product Name">
                                  </div>
                                      ...
                                      <div class="col-md-6 col-sm-6">
                                          ...
                                          <div class="form-group">
                                       <input type="text" class="form-control reserve-form empty iconified" name="date_and_time" id="datetimepicker2"  placeholder="&#xf017;  Time">
                                           </div>
                                    </div>
      ...
      <div class="modal-footer">
        ...
        <section id="great-place-to-enjoy" class="great-place-to-enjoy">
            <img class="img-responsive section-icon hidden-sm hidden-xs" src="frontend/
            images/icons/beer_black.png">
            <div class="wrapper">
                <div class="container-fluid">
                    <div class="row dis-table">
        ...
        <script type="text/javascript" src="{{asset('frontend/text/javascript')}}"></script>
        <script type="text/javascrassetipfrontend/t" src="{{asset('frontend/text/javascript')}}"></script>
